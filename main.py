...
parser.add_argument('--data', metavar='DIR',
                    help='path to training dataset',default='/home/roit/datasets/KITTI/scene_flow/training/')
parser.add_argument('--dataset', metavar='DATASET', default='KITTI_occ',
                    choices=dataset_names,
                    help='dataset type : ' +
                    ' | '.join(dataset_names))
parser.add_argument('--pretrained', dest='pretrained', default='model_args/model_best.pth.tar',
...
# create model 这里的套路可以借鉴下
    ...
    model = torch.nn.DataParallel(model).cuda()# for multi-GPU
